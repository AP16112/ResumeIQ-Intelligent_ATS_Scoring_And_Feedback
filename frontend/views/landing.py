# This is actually the landing or home page that will be visible to users in UI
...
def render():
    ...
    <div class="main-header">
        <h1>🎯 ResumeIQ - "Intelligent ATS scoring & feedback" </h1>
    ...
    # This will create the three‑column layout in Streamlit with custom width ratio
