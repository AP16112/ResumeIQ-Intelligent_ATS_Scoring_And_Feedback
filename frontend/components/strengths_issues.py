# This file is a Streamlit component for showing resume strengths and critical issues. 
# It organizes positive highlights and urgent problems from the backend analysis into clear, user‑friendly sections.
