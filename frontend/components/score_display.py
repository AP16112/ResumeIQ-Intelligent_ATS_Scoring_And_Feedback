# This file is a Streamlit component for displaying the overall ATS score and its breakdown by category. 
# It takes the backend analysis results and renders them as a big score card plus progress bars for each scoring component.
...
# It defines the scoring components and their maximum values for our ATS Resume Scorer dashboard
