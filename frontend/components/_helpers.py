# This file is a utility module for styling and visual feedback in our ATS Resume Scorer app. 
# It doesn’t do analysis itself — instead, it provides helper functions that map scores or severity levels into colors, emojis, and icons for the UI.
